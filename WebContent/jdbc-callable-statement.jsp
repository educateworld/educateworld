...
<p><div style="font-family: courier;">prepareCall()</div> method is used to return object of CallableStatement.
<p><h3>Syntax</h3>
<div style="font-family: courier;">
<p>CallableStatement stmt=con.prepareCall("{call procedurename(?,?,?)}");  </p></div>
...
<p><h3>Stored Procedure</h3><div style="font-family: courier;">
<p>DELIMITER $$
