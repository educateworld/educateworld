...
<p><b>What is AngularJS?</b></p>
<p>AngularJS is a JavaScript framework that helps build applications that run in a web browser. </p>

<p><b>Who developed AngularJS?</b></p>
<p>Google is the company that developed AngularJS. AngularJS is an open source project, which means it can be be freely used, changed, and shared by anyone.
</p>
<p>AngularJS is an excellent framework for building both Single Page Applications (SPA) and Line of Business Applications. Many companies are using Angular today, and there are many public facing web sites that are built with angular.
<br>
<p>There is a website, https://www.madewithangular.com, that has the list of web sites that are built using AngularJS. Within this list you can find many popular websites.
<br>
<p><b>What are the benefits of using AngularJS?</b><br>
<p>1. Dependency Injection : Dependency Injection is something AngularJS does quite well. If you are new to Dependency Injection, don't worry, we will discuss it in detail with examples in a later video.
<br>
...
<br>
<p>To build angular applications you only need one script file and that is angular.js.
<br>
