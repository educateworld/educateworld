...
<article>
	...
	<p>Abstraction</p>
		...
		<p>
			...
			inside a class body. 
			<p>In java, the braces { } mark the beginning and
			the end of a class or method. Here we use the following notation [ ]
			- optional - are mandatory (must)
			<p> <b>Example:</b> Java follows Naming
			Conventions
		</p>
		<p>Class Name Declaration: <p><div style="font-family: courier;">class EducateWorld
		<p>{</p>
		}</div>
	...
	<div style="font-family: courier;">	<p>Emp e = new Emp();</p></div>
	...
	<div style="font-family: courier;">	<p>e.eno=101;</p></div>
		<p>Here we are assigning values to instance variables using
			"."(Dot) operator</p>
	<div style="font-family: courier;">	<p>e.getEmpDetails ();</p></div>
